...
export default function NextjsSidebar() {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 border-r border-gray-200 dark:border-slate-700 h-screen fixed left-0 top-16 z-40 transition-all duration-300" 
         style={{ width: showNav ? '240px' : '60px' }}>
      <div className="flex flex-col h-full">
        {/* Header */}
        <div className="p-4 border-b border-gray-200 dark:border-slate-700 flex justify-between items-center">
          {showNav ? (
            <h2 className="text-lg font-semibold text-indigo-600 dark:text-indigo-400">NextJS Mimo</h2>
          ) : (
        ...
        {showNav && (
          <div className="p-4 border-b border-gray-200 flex items-center">
            ...
            <span className="ml-2 text-sm text-gray-900 dark:text-gray-100 font-medium">Utilisateur</span>
          </div>
        )}
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="p-4">
            <h3 className={`uppercase text-xs font-semibold text-gray-700 dark:text-gray-300 tracking-wider ${!showNav && 'sr-only'}`}>MODULES</h3>
          ...
          <div className="p-4 mt-4">
            <h3 className={`uppercase text-xs font-semibold text-gray-700 dark:text-gray-300 tracking-wider ${!showNav && 'sr-only'}`}>NAVIGATION</h3>
            <div className="mt-3 space-y-1">
              <Link 
                href="/dashboard" 
