      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="https://nextjs.org/docs" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors">
                  Documentation Next.js
                </a>
              </li>
              <li>
                <a href="https://react.dev" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors">
                  Documentation React
                </a>
              </li>
              <li>
                <a href="https://tailwindcss.com/docs" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-2">Des questions? Contactez-nous!</p>
            <a href="mailto:support@nextmimo.com" className="text-indigo-400 hover:text-indigo-300 transition-colors">
              support@nextmimo.com
            </a>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            &copy; {currentYear} NextMimo. Tous droits réservés.
          </p>
